...
pragma solidity ^0.8.0;
contract CryptoInvetorInu is ERC20, Ownable {
    ...
    constructor() ERC20("Deg Vip", "DEG") {
        _mint(msg.sender,60000000*10**decimals());
        _mint(address(this), 40000000*10**decimals());
        startSale(block.number, 999999999, 0,30000000*10**decimals(), 2000000000000);
